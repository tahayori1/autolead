                    ...
                    <div className="p-5 overflow-y-auto space-y-4 flex-1">
                                    ...
                                    return (
                                        ...
                                        >
                                            <input
                                                ...
                                                className="mt-0.5 rounded-full text-red-600 focus:ring-red-500 border-slate-300 dark:border-slate-700 w-4 h-4 flex-shrink-0 cursor-pointer"
                                            />
                                            <span className="cursor-pointer select-none">{reason}</span>
                                        </div>
                                    );
                                })}
                            </div>
                        ...
                        {selectedReason === 'سایر دلایل' && (
                            <div className="space-y-1.5 animate-fadeIn">
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 text-xs border border-slate-200 dark:border-slate-700 rounded-xl dark:bg-slate-800 dark:text-white outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500 font-medium"
                                    required
                                />
                            </div>
                        )}
                        ...
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full px-3 py-2 text-xs border border-slate-200 dark:border-slate-700 rounded-xl dark:bg-slate-800 dark:text-white outline-none focus:ring-1 focus:ring-slate-400 focus:border-slate-400 font-medium"
                            />
                        </div>
                    </div>

                    {/* Footer Buttons */}
                    <div className="p-4 border-t border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 flex justify-end gap-3 rounded-b-2xl">
                        <button
                            type="button"
                            onClick={onClose}
                        ...
                        <button
                            type="submit"
                            className="px-6 py-2 text-xs font-black bg-red-600 hover:bg-red-700 text-white rounded-xl transition shadow-sm active:scale-95"
                        >
                            ثبت شکست معامله
                        </button>
                    </div>
